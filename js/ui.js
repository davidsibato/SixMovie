...
showMovies(data) {
    ...
    <div class="card-reveal black">
      ...
      <p class="green-text">Year:<span class="red-text">${results.Year}</span></p>
        ...
        <a class="waves-effect waves-light green btn-small" onclick="movieClicked('${results.imdbID}')"
        href="#">More Info..</a>
...
showInfo(info){
  ...
  <div class="card horizontal">
    ...
    <div class="card-action">
        <a href="https://www.imdb.com/title/${info.imdbID}" target="_blank">View on IMDB>>></a>
...
showSearch(data){
  let output='';
    ...
    <div class="card-reveal black">
      <span class="card-title white-text text-darken-4">${results.Title}<i class="material-icons right">close</i></span>
      <p class="green-text">Type: <span class="red-text">${results.Type}</span></p>
      <p class="green-text">Type: <span class="red-text">${results.Year}</span></p>
