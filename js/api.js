class OMDB {
    ...
    async getMovies(){
        const movieResponse= await fetch(`http://www.omdbapi.com/?apikey=${this.key}&s=movie
        `);
        const seriesResponse= await fetch(`http://www.omdbapi.com/?apikey=${this.key}&s=new
        `);
